...
export default function GlobalErrorModal({
  ...
  useEffect(() => {
    console.error("Uncaught Next.js Runtime Error:", error);
  }, [error]);

  return (
    <div className="fixed inset-0 bg-black/80 backdrop-blur-md z-50 flex items-center justify-center p-4 animate-fade-in">
      <div className="bg-[#0A101D] border border-red-500/30 rounded-3xl p-6 md:p-8 max-w-lg w-full shadow-[0_10px_50px_rgba(239,68,68,0.25)] text-center relative overflow-hidden">
        ...
        <h2 className="text-xl font-bold text-white mb-2">Ha ocurrido un error en la página</h2>
        <p className="text-slate-400 text-xs mb-4">Se interceptó un problema durante la carga de los datos o la ejecución.</p>
        ...
        <div className="text-red-300 text-sm leading-relaxed mb-6 bg-[#15233D]/70 p-4 rounded-2xl border border-red-500/20 break-words max-h-60 overflow-y-auto text-left font-mono">
          {error.message || "Error desconocido al intentar procesar la vista o comunicar con el servidor."}
