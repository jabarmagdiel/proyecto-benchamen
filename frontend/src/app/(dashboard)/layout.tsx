...
export default function DashboardLayout({
  ...
  return (
    <div className="flex min-h-screen bg-[#0A101D] text-white selection:bg-[#20CDFE]/30">
      <Sidebar />
      <div className="flex-1 flex flex-col min-w-0 bg-[#0A101D] relative overflow-hidden">
