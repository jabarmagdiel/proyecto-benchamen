...
export default function DashboardPage() {
  ...
  const CustomTooltip = ({ active, payload }: any) => {
    if (active && payload && payload.length) {
      return (
        <div className="bg-[#0A101D]/95 backdrop-blur-md border border-slate-800/50 p-3 rounded-xl shadow-xl text-white text-xs font-semibold">
  ...
  return (
    <div className="space-y-6 animate-fade-in pb-12">
      ...
      <div className="bg-gradient-to-r from-[#20CDFE]/20 via-[#2E455C]/40 to-[#07060B] border border-slate-800 rounded-3xl p-6 md:p-8 text-white shadow-xl shadow-indigo-900/15 relative overflow-hidden flex flex-col md:flex-row md:items-center justify-between gap-6">
        ...
        <div className="relative z-10 space-y-2">
          <div className="flex items-center gap-2">
            <span className="bg-[#0A101D]/10 backdrop-blur-md px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider text-indigo-100 flex items-center gap-1.5 border border-slate-800/50">
        ...
        {stats && (
          <div className="relative z-10 shrink-0 bg-[#0A101D]/10 backdrop-blur-md border border-slate-800/50 rounded-2xl p-4 flex gap-4 text-center">
            <div className="px-2">
      ...
      {user?.role !== "cliente" && (
        <div className="bg-[#0A101D]/50 backdrop-blur-xl rounded-2xl border border-slate-800/50 p-4 shadow-sm flex flex-wrap items-center justify-between gap-4">
          ...
          <div className="flex flex-wrap items-center gap-3">
            {user?.role === "administrador" && (
              <select
                ...
                className="px-3 py-2 border border-slate-800/50 rounded-xl bg-[#0A101D] text-xs font-semibold text-white focus:outline-none focus:ring-2 focus:ring-violet-200"
              >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            {loadingClientProjects ? (
              ...
              <div className="bg-[#0A101D]/50 backdrop-blur-xl rounded-2xl border border-slate-800/50 p-8 text-center text-slate-400 text-sm">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {clientProjects.map((proj) => {
                  ...
                  return (
                    <div key={proj.id} className="bg-[#0A101D]/50 backdrop-blur-xl rounded-2xl border border-slate-800/50 p-5 shadow-sm flex flex-col justify-between hover:shadow-md hover:-translate-y-0.5 transition-all duration-300">
                      <div>
                      ...
                      <div className="space-y-4">
                        ...
                        <button
                          ...
                          className="w-full flex items-center justify-center gap-1.5 bg-[#20CDFE]/20 hover:bg-[#20CDFE] text-white hover:text-white py-2 rounded-xl text-xs font-bold transition-all duration-300 border border-slate-800"
                        >
                          <Sparkles size={13} />
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            {/* Launchpad rápido */}
            <div className="bg-[#0A101D]/50 backdrop-blur-xl rounded-2xl border border-slate-800/50 p-5 shadow-sm space-y-4">
              ...
              <div className="grid grid-cols-1 gap-2.5">
                <Link
                  href="/agenda"
                  className="flex items-center justify-between p-3 rounded-xl border border-slate-800/50 hover:border-[#20CDFE]/50 hover:bg-[#20CDFE]/10 text-white font-semibold text-xs transition-all duration-300 group"
                >
              ...
              {recentNotifications.length === 0 ? (
                ...
                <div className="space-y-3">
                  {recentNotifications.map(n => (
                    <div key={n.id} className="p-3 bg-[#15233D]/60 rounded-xl border border-slate-800/50 relative flex items-start gap-2.5">
      ...
      {user?.role !== "cliente" && stats && (
        <>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 bg-[#0A101D]/50 backdrop-blur-xl rounded-2xl border border-slate-800/50 shadow-sm p-6 flex flex-col justify-between hover:shadow-md transition-shadow duration-300">
              <div>
                ...
                <div className="flex flex-col sm:flex-row items-center justify-around gap-6">
                  ...
                  <div className="grid grid-cols-2 gap-3 w-full sm:w-auto">
                    {activity_by_status.map((item) => {
                      ...
                      return (
                        <div key={item.status} className="flex items-center gap-2 px-3 py-2 rounded-xl border border-slate-800/50 hover:bg-[#15233D] transition-colors">
            ...
            <div className="bg-[#0A101D]/50 backdrop-blur-xl rounded-2xl border border-slate-800/50 shadow-sm p-6 flex flex-col justify-between hover:shadow-md transition-shadow duration-300">
              <div>
              ...
              <div className="space-y-3 flex-1 overflow-y-auto max-h-[260px] pr-1">
                {activity_by_status.map((s) => {
                  ...
                  const borderStyles = STATUS_BORDER_COLORS[s.status] || "border-slate-800/50 bg-[#15233D] text-slate-600";
                  const percent = totalActivities > 0 ? Math.round((s.count / totalActivities) * 100) : 0;

                  return (
                    <div key={s.status} className="flex items-center justify-between p-2 rounded-xl border border-slate-800/50 hover:border-slate-800/50 hover:shadow-sm transition-all duration-300 group">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 bg-[#0A101D]/50 backdrop-blur-xl rounded-2xl border border-slate-800/50 shadow-sm p-6 hover:shadow-md transition-shadow duration-300">
              <div className="mb-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 bg-[#0A101D]/50 backdrop-blur-xl rounded-2xl border border-slate-800/50 p-5 shadow-sm space-y-4">
              <h3 className="text-sm font-bold text-white flex items-center gap-2">
                <Bell size={15} className="text-[#20CDFE]" />
              ...
              {recentNotifications.length === 0 ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                  {recentNotifications.map((n) => (
                    <div key={n.id} className="p-3.5 bg-[#15233D]/50 rounded-xl border border-slate-800/50/30 flex flex-col justify-between gap-3 hover:bg-[#15233D] transition-colors">
                      ...
                      <button
                        onClick={() => handleReadNotification(n.id)}
                        className="text-[9px] font-extrabold text-[#20CDFE] hover:text-violet-800 border-t border-slate-800/50 pt-2 text-left"
                      >
                        Marcar como leída
                      </button>
                    </div>
      ...
      {deliverablesModalProject && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-[#0A101D] rounded-2xl shadow-2xl w-full max-w-2xl animate-fade-in max-h-[85vh] flex flex-col overflow-hidden">
              ...
              {loadingDeliverables ? (
                ...
                <div className="space-y-6">
                  {projectDeliverables.map((item) => (
                    <div key={item.activity.id} className="p-4 rounded-xl border border-slate-800/50 bg-[#15233D]/20 space-y-3">
                      <div className="flex items-center justify-between border-b border-slate-800/50/50 pb-2">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                        {item.evidences.map((ev) => {
                          ...
                          return (
                            <div key={ev.id} className="p-3 bg-[#0A101D] border border-slate-800/50 rounded-xl flex items-center justify-between gap-3 shadow-sm hover:shadow-md transition-shadow">
                              <div className="min-w-0">
            ...
            <div className="p-6 border-t border-slate-800/50 bg-[#15233D]/50 shrink-0 flex justify-end">
              <button 
                onClick={() => setDeliverablesModalProject(null)}
                className="px-5 py-2.5 border border-slate-800/50 bg-[#0A101D] rounded-xl text-sm font-semibold text-slate-600 hover:bg-[#15233D] transition-colors"
              >
                Cerrar Ventana
              </button>
            </div>
